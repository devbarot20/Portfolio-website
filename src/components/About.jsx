      ...
      <div className="max-w-6xl mx-auto px-6 md:px-10">
        <div className="grid md:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          >
            {/* spinning orbit ring */}
            <div
              className="absolute w-80 h-80 md:w-96 md:h-96 rounded-full border border-dashed border-indigo-500/20 animate-spin-slow"
              style={{ animationDuration: '30s' }}
            />

            {/* avatar card */}
            <div className="relative w-64 h-64 md:w-72 md:h-72 rounded-3xl glass-strong border border-white/10 flex flex-col items-center justify-center glow">
              <div className="text-7xl mb-3 animate-float" style={{ animationDelay: '0.5s' }}>👨‍💻</div>
              <p className="font-mono text-sm text-indigo-400">Alex Johnson</p>
              <p className="text-xs text-slate-500 mt-1">Frontend Developer</p>

              {/* highlight pills inside card bottom */}
              <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 flex-wrap justify-center w-full px-3">
          ...
          <div ref={rightRef} className={`reveal-right ${rightIn ? 'in-view' : ''}`}>
            ...
            <h2 className="text-4xl md:text-[2.75rem] font-black leading-tight mb-2">
              Crafting Digital<br />
            ...
            <div className="space-y-4 text-slate-400 leading-relaxed text-[0.95rem]">
              <p>
                I'm <span className="text-white font-semibold">Alex Johnson</span>, a passionate Frontend
